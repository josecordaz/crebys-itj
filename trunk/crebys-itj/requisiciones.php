...
<div id="titulo">Concentrado de Requisiciones</div>
<div>
<?php
	if($_GET['ciclo']==1||!isset($_GET['ciclo'])||$_GET['ciclo']>2){
		echo "<a class=\"link-selected\" href=\"requisiciones.php?ciclo=1\">Agosto - Diciembre</a>";
   		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<a class=\"link-unselected\" href=\"requisiciones.php?ciclo=2\">Enero - Junio</a>";
		$meses=array("Agosto","Septiembre","Octubre","Noviembre","Diciembre");
	}
	else{
		echo "<a class=\"link-unselected\" href=\"requisiciones.php?ciclo=1\">Agosto - Diciembre</a>";
   		echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;";
		echo "<a class=\"link-selected\" href=\"requisiciones.php?ciclo=2\">Enero - Junio</a>";
...
<?php
	for($i=0;$i<count($meses);$i++){
		if($_GET['mes']==$i||(!isset($_GET['mes'])&&$i==0))
	    	echo "<li class=\"current\"><a href=\"#\"><span>".$meses[$i]."</span></a></li>";
		elseif(isset($_GET['ciclo']))
				echo "<li><a href=\"requisiciones.php?ciclo=".$_GET['ciclo']."&mes=".$i."\"><span>".$meses[$i]."</span></a></li>";
			else
				echo "<li><a href=\"requisiciones.php?ciclo=1&mes=".$i."\"><span>".$meses[$i]."</span></a></li>";
	}
?>
	<input type="button" onclick="location='insumos-requisiciones.php'" value="Agregar Requisicion"/>
    </ul>
    </div>
</div>
